...
import { comments, sites, threads, users } from "./schema";
...
async function seed() {
  ...
  await db.insert(threads).values([
    {
      ...
      siteId,
      threadKey: "article-1",
      title: "Membangun Comment System Bertingkat di Laravel",
    },
    {
      id: t2Id,
      siteId,
      threadKey: "article-2",
      title: "Fitur Notifikasi di Blog: Apa Saja yang Perlu Dipertimbangkan",
    },
    {
      id: t3Id,
      siteId,
      threadKey: "article-3",
      title: "Tips Menulis Artikel yang SEO Friendly di 2024",
    },
  ]);
  ...
  await db.insert(comments).values({
    ...
    content:
      "Artikel yang sangat bermanfaat! Penjelasannya jelas dan mudah dipahami, terutama bagian tentang implementasi sistem komentar bertingkat.",
    htmlContent:
      "<p>Artikel yang sangat bermanfaat! Penjelasannya jelas dan mudah dipahami, terutama bagian tentang implementasi sistem komentar bertingkat.</p>",
    status: "approved",
    likesCount: 12,
  ...
  await db.insert(comments).values({
    ...
    htmlContent:
      "<p>Terima kasih banyak atas apresiasinya! 🙏<br>Senang sekali artikel ini bisa membantu.</p>",
    status: "approved",
    likesCount: 5,
  ...
  await db.insert(comments).values({
    ...
    content:
      "Setuju! Struktur komentar bertingkat seperti ini bikin diskusi lebih terarah dan nyaman dibaca.",
    htmlContent:
      "<p>Setuju! Struktur komentar bertingkat seperti ini bikin diskusi lebih terarah dan nyaman dibaca.</p>",
    status: "approved",
    likesCount: 3,
  ...
  await db.insert(comments).values({
    ...
    htmlContent:
      "<p>Apakah ada rencana untuk menambahkan notifikasi balasan komentar melalui email?</p>",
    status: "pending",
    likesCount: 2,
