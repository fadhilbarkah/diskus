...
import { Lock, Monitor, Moon, Palette, Sun, User } from "lucide-preact";
...
import { globalSearchQuery, theme } from "../lib/store";

export function Settings() {
  const loading = useSignal(true);
  const savingProfile = useSignal(false);
  const savingPassword = useSignal(false);
  const _savingIntegrations = useSignal(false);
  ...
  return (
    <div class="animate-in fade-in duration-300">
      ...
      <div class="max-w-3xl mx-auto pb-12">
        <PageHeader title="Settings" description="Manage your preferences and profile details" />
                ...
                <Card>
                  ...
                  <div class="flex items-center gap-4 mb-4">
                    <div class="w-16 h-16 rounded-full overflow-hidden shrink-0 select-none border border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-[#27272a] shadow-sm">
                      <img
                        src={`https://api.dicebear.com/10.x/thumbs/svg?seed=${avatarSeed.value}`}
                        alt="Avatar"
                    ...
                    <div>
                      ...
                      <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                        Your avatar is generated based on your email.
                      </p>
                    </div>
                  </div>
