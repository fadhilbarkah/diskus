...
import { ArrowLeft, Database, Lock, Mail, Save, Shield } from "lucide-preact";
        ...
        <form onSubmit={handleUpdateSite} class="space-y-6">
          {(() => {
            ...
            if (!showAuth && !showModeration && !showEmail && !showData) {
              return (
                <div class="text-center py-20 text-gray-500">No settings match your search.</div>
              );
            }
              ...
              <>
                {showAuth && (
                  <Card>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <label
                        class={`flex items-start gap-4 p-4 rounded-xl border cursor-pointer transition-colors ${!requireLoginSetting.value ? "border-blue-600 bg-blue-50 dark:bg-blue-900/30" : "border-gray-200 dark:border-gray-700 bg-white dark:bg-[#18181b] hover:bg-gray-50 dark:hover:bg-[#27272a]"}`}
                      >
                        <div class="pt-0.5">
                          <input
                            type="radio"
                        ...
                        <div>
                          <div
                            class={`font-medium text-sm ${!requireLoginSetting.value ? "text-blue-900 dark:text-blue-400" : "text-gray-900 dark:text-gray-100"}`}
                          >
                            Guest & Login Allowed
                          </div>
                          <div
                            class={`text-xs mt-1 leading-relaxed ${!requireLoginSetting.value ? "text-blue-700 dark:text-blue-300" : "text-gray-500 dark:text-gray-400"}`}
                          >
                            Visitors can post comments as Guests without creating an account.
                          </div>
                        </div>
                      </label>
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div
                            class={`text-xs mt-1 leading-relaxed ${requireLoginSetting.value ? "text-blue-700 dark:text-blue-300" : "text-gray-500 dark:text-gray-400"}`}
                          >
                            Visitors must log in or register an account first to post comments.
                          </div>
                        </div>
                      </label>
                    </div>
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-100 dark:border-gray-800">
                      ...
                      <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                        <label
                          class={`flex items-center gap-3 p-3 rounded-xl border cursor-pointer transition-colors ${enabledSocialLoginsSetting.value.includes("google") ? "border-blue-600 bg-blue-50 dark:bg-blue-900/30" : "border-gray-200 dark:border-gray-700 bg-white dark:bg-[#18181b] hover:bg-gray-50 dark:hover:bg-[#27272a]"}`}
                        >
                          <input
                            type="checkbox"
                            ...
                            onChange={(e) => {
                              if ((e.target as HTMLInputElement).checked) {
                                enabledSocialLoginsSetting.value = [
                                  ...enabledSocialLoginsSetting.value,
                                  "google",
                                ];
                              } else {
                                enabledSocialLoginsSetting.value =
                                  enabledSocialLoginsSetting.value.filter((p) => p !== "google");
                              }
                            }}
                            class="w-4 h-4 text-blue-600 border-gray-300 dark:border-gray-600 rounded focus:ring-blue-500 cursor-pointer"
                          />
                          <span
                            class={`flex items-center font-medium text-sm ${enabledSocialLoginsSetting.value.includes("google") ? "text-blue-900 dark:text-blue-400" : "text-gray-900 dark:text-gray-100"}`}
                          >
                        ...
                        <label
                          class={`flex items-center gap-3 p-3 rounded-xl border cursor-pointer transition-colors ${enabledSocialLoginsSetting.value.includes("github") ? "border-blue-600 bg-blue-50 dark:bg-blue-900/30" : "border-gray-200 dark:border-gray-700 bg-white dark:bg-[#18181b] hover:bg-gray-50 dark:hover:bg-[#27272a]"}`}
                        >
                          <input
                            type="checkbox"
                            ...
                            onChange={(e) => {
                              if ((e.target as HTMLInputElement).checked) {
                                ...
                                enabledSocialLoginsSetting.value =
                                  enabledSocialLoginsSetting.value.filter((p) => p !== "github");
                              }
                            }}
                            class="w-4 h-4 text-blue-600 border-gray-300 dark:border-gray-600 rounded focus:ring-blue-500 cursor-pointer"
                          />
                          <span
                            class={`flex items-center font-medium text-sm ${enabledSocialLoginsSetting.value.includes("github") ? "text-blue-900 dark:text-blue-400" : "text-gray-900 dark:text-gray-100"}`}
                          >
                            <svg
                              class={`w-4 h-4 mr-1.5 ${enabledSocialLoginsSetting.value.includes("github") ? "text-blue-900 dark:text-blue-400" : "text-gray-900 dark:text-white"}`}
                              fill="currentColor"
                              viewBox="0 0 24 24"
                            >
                              <path
                ...
                {showModeration && (
                  <Card>
                    ...
                    <div class="space-y-6">
                      <label
                        class={`flex items-start gap-4 p-4 rounded-xl border cursor-pointer transition-colors ${requireModerationSetting.value ? "border-blue-600 bg-blue-50 dark:bg-blue-900/30" : "border-gray-200 dark:border-gray-700 bg-white dark:bg-[#18181b] hover:bg-gray-50 dark:hover:bg-[#27272a]"}`}
                      >
                        <div class="pt-0.5">
                          <input
                            type="checkbox"
                            ...
                            onChange={(e) =>
                              (requireModerationSetting.value = (
                        ...
                        <div>
                          <div
                            class={`font-medium text-sm ${requireModerationSetting.value ? "text-blue-900 dark:text-blue-400" : "text-gray-900 dark:text-gray-100"}`}
                          >
                            Require Moderation
                          </div>
                          <div
                            class={`text-xs mt-1 leading-relaxed ${requireModerationSetting.value ? "text-blue-700 dark:text-blue-300" : "text-gray-500 dark:text-gray-400"}`}
                          >
                            New comments from visitors will be pending until you approve them
                            manually.
                          </div>
                        </div>
                      </label>
                      ...
                      <div>
                        ...
                        <div class="flex items-center gap-3">
                          <input
                            ...
                            onInput={(e) =>
                              (commentsLimitSetting.value = parseInt(
                                (e.target as HTMLInputElement).value,
                                10,
                              ))
                            }
                          ...
                          <div class="text-xs text-gray-500 dark:text-gray-400">
                            root comments to show before the "Load More" button.
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                {showEmail && (
                  <Card>
                    ...
                    />
                    <label
                      class={`flex items-start gap-4 p-4 rounded-xl border cursor-pointer transition-colors ${enableEmailSetting.value ? "border-blue-600 bg-blue-50 dark:bg-blue-900/30" : "border-gray-200 dark:border-gray-700 bg-white dark:bg-[#18181b] hover:bg-gray-50 dark:hover:bg-[#27272a]"}`}
                    >
                      <div class="pt-0.5">
                        <input
                          type="checkbox"
                          ...
                          onChange={(e) =>
                            (enableEmailSetting.value = (e.target as HTMLInputElement).checked)
                          }
                          class="w-4 h-4 text-blue-600 border-gray-300 dark:border-gray-600 rounded focus:ring-blue-500 cursor-pointer"
                        />
                      </div>
                      <div>
                        <div
                          class={`font-medium text-sm ${enableEmailSetting.value ? "text-blue-900 dark:text-blue-400" : "text-gray-900 dark:text-gray-100"}`}
                        >
                          Notify on New Comments
                        </div>
                        <div
                          class={`text-xs mt-1 leading-relaxed ${enableEmailSetting.value ? "text-blue-700 dark:text-blue-300" : "text-gray-500 dark:text-gray-400"}`}
                        >
                          Receive an email automatically whenever someone posts a new comment on
                          your website.
                        </div>
                      </div>
                    </label>
                    ...
                    <div class="space-y-6 flex flex-col flex-1">
                      <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-auto pt-2">
                        <Button
                          ...
                          class="text-gray-600 dark:text-gray-400 border-gray-200 dark:border-gray-700"
                        >
                        ...
                        <div class="relative">
                          ...
                          <Button
                            ...
                            class="text-white hover:bg-[#1d82db]"
                          >
